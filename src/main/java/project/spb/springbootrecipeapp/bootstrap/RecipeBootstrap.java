package project.spb.springbootrecipeapp.bootstrap;

import lombok.extern.slf4j.Slf4j;
import org.springframework.context.ApplicationListener;
import org.springframework.context.event.ContextRefreshedEvent;
import org.springframework.stereotype.Component;
import project.spb.springbootrecipeapp.domain.*;
import project.spb.springbootrecipeapp.repositories.CategoryRepository;
import project.spb.springbootrecipeapp.repositories.RecipeRepository;
import project.spb.springbootrecipeapp.repositories.UnitOfMeasureRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        log.debug("Loading recipes on startup!");
